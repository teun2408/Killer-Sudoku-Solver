...
{
    public class Large16x16Hard : ISudoku
    {
        public KillerSudoku CreateSudoku(bool logging)
        {
            List<List<int>> fieldslist = new List<List<int>>
            {
                ...
                new List<int>() { 0, 0, 0, 0, 1, 0, 14, 0, 0, 0, 0, 10, 0, 16, 0, 13 },
                ...
                new List<int>() { 5, 11, 3, 10, 0, 14, 0, 8, 0, 0, 12, 4, 0, 0, 0, 1 },
                new List<int>() { 0, 14, 0, 0, 11, 9, 0, 1, 0, 13, 15, 0, 4, 10, 5, 0 },
                new List<int>() { 13, 0, 4, 0, 6, 0, 3, 0, 0, 0, 0, 2, 0, 12, 0, 9 },
            ...
            return new KillerSudoku(new List<Cage>(), board, "large 16 x 16 Hard");
        }
    }
}
